...
public class LedgerExpandableAdapter extends RecyclerView.Adapter<LedgerExpandableAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tvSeqRange.setText("Files " + item.getStartSequence() + " to " + item.getEndSequence());
        holder.tvFileCount.setText(item.getTotalFiles() + " files");
        holder.tvTotalSize.setText(LocalFileHelper.getReadableSize(item.getTotalSize()));
